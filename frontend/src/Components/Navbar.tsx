...
//   { name: "Ask your Doubts", href: "/chathere", current: false },
// ];
...
export function Navbar() {
    ...
    return (
      <>
        <div  className="fixed top-0 w-full h-14 bg-neutral-900 flex items-center px-5">
            <h2 onClick={()=> navigate("/")} style={{fontFamily:"cursive"}} className="text-blue-500 text-left font-bold text-2xl cursor-pointer">SmartAI</h2>
        </div>
